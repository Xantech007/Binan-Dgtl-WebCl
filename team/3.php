...
$l1_codes = $stmt->fetchAll(PDO::FETCH_COLUMN);
...
if($l1_codes){
    ...
    $l2_codes = $stmt->fetchAll(PDO::FETCH_COLUMN);
...
foreach($members as $m){
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | TOTAL GENERATED FOR YOU (LEVEL 3)
    |--------------------------------------------------------------------------
    */
